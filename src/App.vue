...
<nav class="navbar navbar-light navbar-expand-lg fixed-top" id="mainNav">
 ...
 <div  class="collapse navbar-collapse" id="navbarResponsive">
  <ul class="nav navbar-nav ml-auto">
    ...
    <li class="nav-item" role="presentation"><router-link to="/aboutme">Sobre Mi</router-link></li> 
    <li class="nav-item" role="presentation"><router-link to="/Contact">Contacto</router-link></li> 
    <li class="nav-item" role="presentation"><router-link to="/post/1">Ultimo Post</router-link></li> 
  </ul>
</div>
</div>
</nav>
